...
- Sınıf, öğrenci, değerlendirme, yoklama, ders programı, ödev ve AI çıktısı endpointleri oturumdaki öğretmene göre izole edilir.
...
- Öğrenci verilerinin OpenAI API'ye gönderildiği, uygulama içinde Ayarlar → Gizlilik ve Veri bölümünde öğretmene açıkça belirtilir (bkz. `frontend/src/pages/SettingsPage.jsx`). Kurum politikasına göre veli/idare onay sürecini işletmek öğretmenin/kurumun sorumluluğundadır — uygulama bu onayı takip etmez.
